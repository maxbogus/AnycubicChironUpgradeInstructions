...
#define STRING_CONFIG_H_AUTHOR "(For Anycubic Chiron by Erik)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 100, 400, 418.43 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -26.86, -4, -.9}
...
#define Z_PROBE_SPEED_FAST HOMING_FEEDRATE_Z+50
